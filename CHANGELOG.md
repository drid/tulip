...
- Feat: Add roadbook logo remove handle
fix: New roadbook does not clear logo, closes #52
...
- Waypoint number as name
- Add distance
- Add coordinate visibility
- Add reset
- Add danger
- Add cap
...
- Refactor: Update Quill to 2.0.1
refactor: New roadbook code
